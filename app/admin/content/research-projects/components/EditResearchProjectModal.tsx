...
interface EditResearchProjectModalProps {
  project: ResearchProject;
  onClose: () => void;
  onSuccess: () => void;
}

const EditResearchProjectModal: React.FC<EditResearchProjectModalProps> = ({
  project,
  onClose,
  onSuccess
}) => {
  const { updateProject } = useResearchProjects();
  ...
  const [formData, setFormData] = useState({
    ...
    studentParticipants: project.studentParticipants?.toString() || '',
    ethicsApproval: project.ethicsApproval || '',
    featured: project.featured,
    published: project.published,
    allowPublicView: project.allowPublicView,
    link: project.link || '',
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-xl font-bold text-gray-900">Editar Proyecto: {project.title}</h2>
          <button
            onClick={onClose}
...
export default EditResearchProjectModal;